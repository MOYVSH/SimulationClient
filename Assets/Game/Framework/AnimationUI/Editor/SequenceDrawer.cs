    ...
    public class SequenceDrawer : PropertyDrawer
    {
        ...
        public override float GetPropertyHeight(SerializedProperty property, GUIContent label)
        {
            ...
            if (sequenceType == Sequence.Type.Animation)
            {
                ...
                {
                    Sequence.RtTask rtTask = (Sequence.RtTask)property.FindPropertyRelative("TargetRtTask").intValue;
                ...
                {
                    Sequence.TransTask transTask = (Sequence.TransTask)property.FindPropertyRelative("TargetTransTask").intValue;
                ...
                {
                    Sequence.ImgTask imgTask = (Sequence.ImgTask)property.FindPropertyRelative("TargetImgTask").intValue;
                ...
                {
                    Sequence.CgTask cgTask = (Sequence.CgTask)property.FindPropertyRelative("TargetCgTask").intValue;
                    if (cgTask.HasFlag(Sequence.CgTask.Alpha)) totalHeight += _height * 3;
                }
                else if (objectType == Sequence.ObjectType.Camera)
                {
                    Sequence.CamTask camTask = (Sequence.CamTask)property.FindPropertyRelative("TargetCamTask").intValue;
                ...
                {
                    Sequence.TextMeshProTask textMeshProTask = (Sequence.TextMeshProTask)property.FindPropertyRelative("TargetTextMeshProTask").intValue;
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            Rect backgroundRect = new Rect(_backgroundRectExtra.x, position.y + _backgroundRectExtra.y, position.width + _backgroundRectExtra.width,

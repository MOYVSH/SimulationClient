...
namespace MOYV.StringTypes
{
    ...
    public unsafe struct String2048 : IBinarySerializable, ISpanStringType
    {
        ...
        public int length;
        [SerializeField] [FieldOffset(4)] public fixed char chars[1022];
        public String2048(string str)
        {
            e0 = default;
            e1 = default;

            var span = e0.AsSpan<InlineString1024, char>(sizeof(String2048) / 2);
            length = StringTypeUtils.CharsFromString<String2048>(str, span);
        }
        ...
        public static implicit operator string(String2048 str)
        {
            return new string(str.AsCharSpan());
        }

        public static implicit operator String2048(string str)
        {

...
namespace MOYV.StringTypes
{
    ...
    public unsafe struct String1024 : IBinarySerializable, ISpanStringType
    {
        ...
        [SerializeField] [FieldOffset(4)] public fixed char chars[510];

        public String1024(string str)
        {
            e0 = default;

            var span = e0.AsSpan<InlineString1024, char>(sizeof(String1024) / 2);
            length = StringTypeUtils.CharsFromString<String1024>(str, span);
        }
        ...
        public static implicit operator string(String1024 str)
        {
            return new string(str.AsCharSpan());
        }
        
        public static implicit operator String1024(string str)
        {
